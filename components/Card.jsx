...
export default function Card({ job }) {
  return (
    <div
      className={` flex flex-col md:flex-row  relative  gap-6 p-6 pt-10 md:pt-6
    ...
    >
      <img
        ...
        left-6 md:static md:top-auto md:left-auto'
        src={job.logo}
        alt='Company Logo'
      />
      ...
      <section className='flex flex-col  '>
        ...
        <div className='flex flex-col font-bold gap-1'>
          <p>{job.position}</p>
          <div className='flex flex-row gap-4 text-sm font-light text-(--grey-text)'>
            <p>{job.postedAt}</p>
            <span>•</span>
            <p>{job.contract}</p>
            <span>•</span>
